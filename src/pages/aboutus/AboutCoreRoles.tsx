...
//         {/* Header Section */}
//         <section className="max-w-4xl mb-12 md:mb-16 relative mx-auto md:mx-0">
//           <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#1e3a8a] tracking-tight leading-tight">
//             {t('role_main_title') || 'บทบาทและภารกิจหลัก'}
//             <span className="block text-3xl md:text-4xl lg:text-5xl text-slate-400 mt-3 font-medium tracking-normal">
//               {t('role_subtitle') || 'TReN Core Roles & Missions'}
...
//         {/* Intro Section - ปรับให้ไร้กรอบ อ่านง่าย */}
//         <section className="mb-20 md:mb-24">
//           <div className="max-w-4xl text-2xl text-slate-800 font-light leading-relaxed space-y-8">
//             <h3 className="text-3xl font-bold text-[#1e3a8a] leading-snug mb-4">
//               {t('role_intro_headline') || 'องค์กรสนับสนุนหลัก'}
//               <span className="block text-xl text-slate-500 font-medium uppercase tracking-widest mt-2">
//                 {t('role_intro_headline_en') || 'Supporting Body'}
//               </span>
//             </h3>
...
//             <div className="bg-[#f8fafc] border-l-[6px] border-[#1e3a8a] py-4 pl-6 md:pl-8 my-8">
//               <p className="text-2xl text-slate-800 font-light leading-relaxed">
//                 {t('role_intro_p2') || 'TReN ยึดเอา ชุมชน EAR Community (EARC) ในระดับพื้นที่เป็นหัวใจสำคัญ และเข้ามาบริหารจัดการความยั่งยืนด้วยการส่งเสริม หนุนเสริม และสร้างความเข้มแข็ง ให้ชุมชน EARC ในแต่ละภูมิภาคสามารถบริหารจัดการตนเอง พัฒนาศักยภาพสมาชิกด้านการทำวิจัย EAR ได้อย่างต่อเนื่อง พร้อมทั้งขยายผลการอบรมให้ครอบคลุมครูทั่วประเทศได้อย่างพึ่งพาตนเองได้ในระยะยาว'}
//               </p>
//             </div>

//             <p className="font-semibold text-[#1e3a8a] text-2xl pt-2">
//               {t('role_intro_bridge') || 'โดยขับเคลื่อนภารกิจผ่าน 3 เสาหลัก ได้แก่:'}
//             </p>
//           </div>
//         </section>

//         {/* 3 Pillars Section - Vertical Stacking แบบ Boxless */}
//         <div className="space-y-0">
//           {pillars.map((pillar, index) => (
//             <div 
//               key={pillar.id} 
//               className={`flex flex-col md:flex-row items-start gap-6 md:gap-8 lg:gap-16 py-16 border-t border-slate-300 ${index === pillars.length - 1 ? 'border-b' : ''}`}
//             >
              
//               {/* Left Column: Pillar Header */}
//               <div className="md:w-4/12 lg:w-4/12 shrink-0">
//                 <div className="text-xl font-bold tracking-widest uppercase mb-4 flex items-center gap-3 text-[#1e3a8a]">
//                   <span className="w-8 h-[2px] bg-[#1e3a8a]"></span>
//                   {t('role_pillar_prefix') || 'เสาหลักที่'} {pillar.id}
//                 </div>
//                 <h3 className="text-3xl md:text-4xl font-bold text-[#1e3a8a] leading-[1.3] tracking-tight">
//                   {pillar.title}
//                   <span className="block text-xl text-slate-500 font-medium uppercase tracking-widest mt-3">
//                     {pillar.en}
//                   </span>
//                 </h3>
//               </div>
...
//               <div className="md:w-8/12 lg:w-8/12 md:pt-12">
//                 <div className="space-y-12">
//                   {pillar.items.map((item, idx) => (
//                     <div key={idx}>
//                       <h4 className="text-2xl font-bold text-[#1e3a8a] mb-3 flex items-start gap-4">
//                         <span className="text-[#1e3a8a] mt-1 text-2xl leading-none">&bull;</span>
//                         {item.name}
//                       </h4>
//                       <p className="text-2xl text-slate-800 font-light leading-relaxed md:pl-8">
//                         {item.desc}
//                       </p>
//                     </div>
//                   ))}
  ...
  return (
    <div className="w-full bg-[#F8FAFC] font-sans selection:bg-blue-200">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 md:pt-24">
        ...
        <section className="max-w-4xl mb-12 md:mb-16 relative mx-auto md:mx-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#1e3a8a] tracking-tight leading-tight">
            คณะกรรมการบริหารเครือข่าย<br></br>และโครงสร้างองค์กร 
            <span className="block text-3xl md:text-4xl lg:text-5xl text-slate-400 mt-3 font-medium tracking-normal">
              Network Management Structure <br></br>and Organizational Structure
            </span>
          </h1>
          <div className="w-20 h-1.5 bg-[#1e3a8a] mt-8 mb-10 rounded-full"></div>
        </section>
