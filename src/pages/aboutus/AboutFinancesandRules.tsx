    ...
    <div className="w-full bg-[#F8FAFC] font-sans selection:bg-blue-200">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 md:pt-24">
        ...
        <section className="mb-12 md:mb-16">
          <span className="text-slate-500 font-bold block text-2xl md:text-3xl mb-3">{t('const_cat_6') || 'หมวดที่ 6'}</span>
          <h2 className="text-4xl md:text-4xl font-extrabold text-[#1e3a8a] tracking-tight leading-tight">
